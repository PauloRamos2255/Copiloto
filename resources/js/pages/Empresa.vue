            ...
            <main class="p-4 md:p-6">
                ...
                <div
                    ...
                    <div class="relative flex items-center">
                        ...
                        <input v-model="filtro" type="text" placeholder="Filtrar por nombre o teléfono..." class="w-full pl-10 pr-4 h-12 border border-blue-300 rounded-xl
                ...
                <div class="bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-200">
                    <div class="overflow-x-auto">
                        <table class="min-w-full text-sm text-gray-800">
                            ...
                            <!-- Loader Skeleton -->
                            <tbody v-if="cargando">
                                <tr v-for="n in 5" :key="'empresa-skel-' + n"
                                    class="border-b border-gray-100 animate-pulse">
                                    <td class="px-6 py-4">
                                        <div class="h-4 bg-gray-300 rounded" :style="{ width: randomWidthSmall() }">
                                        </div>
                                    </td>
                                ...
                                <tr v-for="(empresa, index) in empresasFiltradasPaginadas" :key="empresa.id"
                                    ...
                                    <td class="px-6 py-4 text-center space-x-2">
                                        ...
                                        <button class="p-2 rounded-full transition-colors" :class="empresa.usuarios_count > 0
                                            ...
                                            :disabled="empresa.usuarios_count > 0" :title="empresa.usuarios_count > 0
