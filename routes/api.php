...
Route::put('/historicoViaje_update', [MovilUsuarioController::class, 'actualizarViajePorId']);
Route::put('/updatehistorico_estado', [MovilUsuarioController::class, 'actualizarEstadoPorViaje']);
